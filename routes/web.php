...
Route::middleware(['auth', 'roles:admin'])->group(function () {
    ...
    Route::controller(SettingController::class)->group(function () {
        Route::get('/site/setting', 'edit')->name('site.setting');
        Route::post('/site/update', 'storeOrUpdate')->name('site.update');
    });

    // Route::resource('site-settings', SettingController::class)->only('edit', 'store', 'update');
